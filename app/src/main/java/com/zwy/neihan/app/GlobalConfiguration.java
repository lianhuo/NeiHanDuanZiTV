...
import com.jess.arms.widget.boxing.BoxingCrop;
...
import static com.zwy.neihan.NeiHanConfig.NETWORK_TIME_OUT;
...
//                        }
                ...
                .responseErrorListener((context1, t) -> {
                    ...
                    Timber.e("responseErrorListener:" + t.getMessage());
                ...
                .okhttpConfiguration((context1, okhttpBuilder) -> {//这里可以自己自定义配置Okhttp的参数
                    okhttpBuilder.writeTimeout(NETWORK_TIME_OUT, SECONDS);
                    okhttpBuilder.connectTimeout(NETWORK_TIME_OUT, SECONDS);
                    okhttpBuilder.readTimeout(NETWORK_TIME_OUT, SECONDS);
...
//                MultiDex.install(base);  //这里比 onCreate 先执行,常用于 MultiDex 初始化,插件化框架的初始化
            ...
            public void onCreate(Application application) {
                if (NeiHanConfig.LOG_DEBUG) {//Timber初始化
        ...
        lifecycles.add(new Application.ActivityLifecycleCallbacks() {
            ...
            public void onActivityStarted(Activity activity) {
                ...
                if (!activity.getIntent().getBooleanExtra("isInitToolbar", false)) {
                    ...
                    if (activity.findViewById(R.id.toobar_iv_back) != null) {
                        activity.findViewById(R.id.toobar_iv_back).setOnClickListener(v -> {
