...
import static com.jess.arms.integration.AppManager.DISSMISSLOADING;
import static com.jess.arms.integration.AppManager.KILL_ALL;
import static com.jess.arms.integration.AppManager.SHOW_ALERTVIEW_BOTTOM;
import static com.jess.arms.integration.AppManager.SHOW_ALERTVIEW_CENTER;
...
public class ArmsUtils {
     ...
     */
    public static void showAlertDialog(String title, String msg, boolean isAccentSureButton, OnClickListener onClickListener) {
        Message message = new Message();
        message.what = SHOW_ALERTVIEW_CENTER;
        message.obj = onClickListener;
        Bundle bundle = new Bundle();
        bundle.putString("title", title);
        bundle.putString("msg", msg);
        bundle.putBoolean("isAccentSureButton", isAccentSureButton);
