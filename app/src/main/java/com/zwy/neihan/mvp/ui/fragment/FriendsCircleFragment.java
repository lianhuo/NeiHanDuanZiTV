 ...
 * 创建人:Alan
 * 文件描述：段友圈 视图页面-fragment
 * 看淡身边的虚伪，静心宁神做好自己。路那么长，无愧走好每一步。
 * ================================================================
 */
public class FriendsCircleFragment extends BaseFragment<FriendsCirclePresenter> implements FriendsCircleContract.View, OnShowLoadingListener {
