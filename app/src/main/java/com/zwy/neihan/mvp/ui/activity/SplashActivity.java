...
import com.zwy.neihan.di.component.DaggerSplashComponent;
import com.zwy.neihan.di.module.SplashModule;
import com.zwy.neihan.mvp.contract.SplashContract;
import com.zwy.neihan.mvp.presenter.SplashPresenter;
 ...
 * ================================================================
 */
public class SplashActivity extends BaseActivity<SplashPresenter> implements SplashContract.View, OnShowLoadingListener {
    ...
    public void initData(Bundle savedInstanceState) {
        mPresenter.initDataAndToNextPage();
    }
